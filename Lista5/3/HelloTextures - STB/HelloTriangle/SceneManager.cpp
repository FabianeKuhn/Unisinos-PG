...
int main()
{
	...
	static string car = "../textures/car.png";
	static string tree = "../textures/tree.png";

	unsigned int cubeTexture = loadTexture(car.c_str());
	unsigned int floorTexture = loadTexture(tree.c_str());
